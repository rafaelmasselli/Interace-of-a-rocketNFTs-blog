...
export function Footer() {
  return (
    <div className='box-footer'>
      <div className='rocket-nft-container'>
        <div className='icon-footer'>
          <h1>
            Rocket <strong>NFTs</strong>
          </h1>
          <div className='box-footer-svg'>
            <svg
              width='23'
              height='23'
              viewBox='0 0 23 23'
            ...
            >
              <path
                d='M9.44174 6.70327L9.79825 22.676L13.1308 22.6016L12.7742 6.62889L20.0871 13.6224L22.3906 11.2138L10.9656 0.287669L0.0395174 11.7127L2.44818 14.0162L9.44174 6.70327Z'
                fill='black'
              />
            </svg>
          </div>
      ...
      <div className='box-footer-email'>
        <div className='box-footer-left'>
          <div>
            <h2>
              Fique por dentro de <br></br> <strong>todas as novidades</strong>
            </h2>
        ...
        <div className='box-footer-right'>
          <div className='text-footer-social'>
            <h3>Empresa</h3> <p>Sobre</p> <p>Serviços</p> <p>Time</p>{" "}
            <p>Carreira</p>
          </div>
          <div className='text-footer-social'>
            <h3>Mapa</h3> <p> Galeria</p> <p> Populares</p> <p>Vendas</p>{" "}
            <p>Contato</p>
          </div>
          <div className='text-footer-social'>
            <h3>Links</h3> <p>FAQs</p> <p>Termos</p> <p>Politica</p>{" "}
            <p>Ajuda</p>
          </div>
        </div>
      </div>
      ...
      <div className='rocket-nft-container'>
        <div className='icon-footer'>
          <p className='web-css'>www.rocketseat.com.br</p>
